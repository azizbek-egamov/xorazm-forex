...
export default function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-2xl border-b transition-all duration-300 ${isDarkMode
    ...
    >
      <div className="flex items-center justify-between px-3 py-2 sm:px-4 sm:py-2 lg:px-8 lg:py-3">
          ...
          >
            <a href="/" className="block">
              <Image
                ...
                width={220}
                height={110}
                className={`h-8 sm:h-12 lg:h-20 w-auto transition-all duration-200 ${isDarkMode ? "brightness-0 invert" : "brightness-100"
                  }`}
                priority
              />
            </a>
        ...
        {/* Desktop Navigation */}
        <nav
          className={`hidden lg:flex items-center space-x-8 text-sm font-medium ${isDarkMode ? "text-gray-200" : "text-gray-700"
            }`}
        >
          <button
            onClick={() => scrollToSection("about-us")}
            className={`flex items-center space-x-2 px-4 py-2 rounded-xl transition-all duration-200 hover:scale-105 ${isDarkMode ? "hover:bg-gray-800/60 hover:text-teal-400" : "hover:text-teal-600 hover:bg-teal-50"
              }`}
          >
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <button
            ...
            className={`w-8 sm:w-10 h-8 sm:h-10 rounded-xl sm:rounded-2xl flex items-center justify-center transition-all duration-200 hover:scale-110 backdrop-blur-md ${isDarkMode
          ...
          <button
            ...
            className={`lg:hidden w-8 sm:w-10 h-8 sm:h-10 rounded-xl sm:rounded-2xl flex items-center justify-center transition-all duration-200 ${isDarkMode
      ...
      >
        <nav className="p-3 sm:p-4 space-y-2">
          <button
            onClick={() => scrollToSection("about-us")}
            className={`w-full flex items-center space-x-3 px-3 sm:px-4 py-2 sm:py-3 rounded-xl transition-all duration-200 text-sm sm:text-base ${isDarkMode
                ? "hover:bg-gray-800/60 text-gray-200 hover:text-teal-400"
