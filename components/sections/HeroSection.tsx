                ...
                <DialogTrigger asChild>
                  <Button
                    ...
                    className={`group w-full sm:w-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 lg:py-6 text-sm sm:text-lg lg:text-xl font-bold flex items-center justify-center space-x-3 transition-all duration-500 hover:scale-110 hover:-translate-y-1 rounded-xl sm:rounded-2xl relative overflow-hidden
                      ${
                        isDarkMode
                          ? "border-2 border-red-500 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 hover:from-red-900 hover:to-red-700 text-white shadow-lg shadow-red-900/20"
                          : "border-2 border-red-500 bg-gradient-to-r from-white via-gray-50 to-white hover:from-red-100 hover:to-red-200 text-red-700 shadow-lg shadow-red-500/10"
                      }
                    `}
                    style={{
                      boxShadow: isDarkMode
                        ? "0 4px 24px 0 rgba(255, 0, 0, 0.10)"
