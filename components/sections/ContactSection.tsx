        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="mb-8">
              ...
              <p className={`text-lg ${isDarkMode ? "text-gray-100" : "text-gray-700"}`}>
          ...
          <div className="space-y-8 lg:space-y-10">
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <p className="text-sm text-gray-200 mb-1">Manzil</p>
              ...
              >
                ...
                <div>
                  <p className="text-sm text-gray-200 mb-1">Ish vaqti</p>
